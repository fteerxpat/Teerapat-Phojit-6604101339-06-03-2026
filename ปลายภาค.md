...
ขั้นตอนที่ 1: เตรียมฐานข้อมูล Supabase (20 คะแนน)
...
ขั้นตอนที่ 3: เตรียม Backend ขึ้นระบบ Render (20 คะแนน)
...
ขั้นตอนที่ 4: เตรียม Frontend ขึ้นระบบ Netlify (20 คะแนน)
...
รูปแบบไฟล์ submission.json (ตัวอย่าง)
{
  ...
  "backend_base_url": "https://xxx.onrender.com",
